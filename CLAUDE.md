...
- [ ] 6.1 Synthetic reply generation
  - [ ] 6.1.1 app/services/inbox.py — generate_synthetic_reply() via Groq
...
- [ ] 6.4 Inbox page
  ...
  - [ ] 6.4.2 app/templates/partials/reply_card.html — reply with sentiment badge, follow-up suggestion
